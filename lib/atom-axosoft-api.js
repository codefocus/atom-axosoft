            ...
            try {
                ...
                this.getApiConsumer()
                    ...
                    .update(featureId, params, (response) => {
                        console.log('updateFeatureWorkflowStep done');
                        console.log(response);
                        // this.data.projects = response.data;
                        resolve();
                    })
                    // .updateWorkflowStep(featureId, params, (response) => {
                    //     console.log('updateFeatureWorkflowStep done');
                    //     console.log(response);
                    //     // this.data.projects = response.data;
                    //     resolve();
                    ...
                    ;
                    // .catch((e) => {
                    //     console.log('updateFeatureWorkflowStep e1');
                    //     console.log(e);
                    //     reject(e);
                    // })
                    // .then((response) => {
                ...
                console.log('updateFeatureWorkflowStep e2');
                console.log(e);
                reject(e);
            }
        });
