...
export default class Feature extends AxosoftDomElement {
    ...
    createElement(feature) {
        ...
        this.addClass(this.statusElement, 'feature-status');
        ...
        this.statusElement.textContent = feature.workflow_step.name;
        this.statusElement.addEventListener(
            'click',
            (event) => {
        ...
        liElement.appendChild(this.statusElement);
    ...
    set workflowStep(workflowStep) {
        ...
        this.statusElement.textContent = workflowStep.name;
    }

    set disabled(isDisabled) {
        this.isDisabled = isDisabled;
        if (this.isDisabled) {
            this.addClass(this.liElement, 'disabled', true);
        } else {
            this.removeClass(this.liElement, 'disabled', true);
        }
